  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background fixed z-50 flex h-auto flex-col transition-transform duration-300",

          // 🔹 TOP drawer animation
          "data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0",
          "data-[vaul-drawer-direction=top]:translate-y-[-100%] data-[state=open]:translate-y-0 data-[state=closed]:translate-y-[-100%]",
          ...
          "data-[vaul-drawer-direction=bottom]:translate-y-[100%] data-[state=open]:translate-y-0 data-[state=closed]:translate-y-[100%]",
          ...
          "data-[vaul-drawer-direction=right]:translate-x-[100%] data-[state=open]:translate-x-0 data-[state=closed]:translate-x-[100%]",
          ...
          "data-[vaul-drawer-direction=left]:translate-x-[-100%] data-[state=open]:translate-x-0 data-[state=closed]:translate-x-[-100%]",
